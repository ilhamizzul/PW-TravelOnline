...
<div class="row">
	<div class="col-md-12">
		<div class="col-md-2 pull-right">
			<button class="btn btn-success pull-right" data-toggle="modal" data-target="#addJenisMobilModal" id="addButton" type="button">Tambah Detail Desa <i class="fa fa-plus"></i></button>
		</div>
