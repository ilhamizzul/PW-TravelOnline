...
<div class="page-header">
  <a href="<?php echo base_url(); ?>index.php/auth/home"><h1 class="logo" style="color: #1e3948">Teknik Informasi <small>TRAVEL ONLINE</small></h1></a>
</div>
<?php
...
<form class="form-horizontal" action="<?php echo base_url(); ?>index.php/admin_auth/login_admin_submit" id="login-form" enctype="multipart/form-data" method="post">
