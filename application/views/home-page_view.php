    ...
    <?php 
        if($this->session->logged_in == true && !is_null($this->session->userdata('ID_MEMBER'))){
          ...
          foreach ($data_trevel as $data) {
            $src = base_url().'assets/uploads/'.$data->LOGO;
            if ($data->LOGO == "" || is_null($data->LOGO)) {
              $src = base_url().'assets/img/default.jpg';
            }

            $srcMobil = base_url().'assets/uploads/'.$data->FOTO_KENDARAAN;
            if ($data->FOTO_KENDARAAN == "" || is_null($data->FOTO_KENDARAAN)) {
              $srcMobil = base_url().'assets/img/default.jpg';
            }
          echo '
            <div class="col-md-12 col-sm-12 content">
              <div class="col-md-3 col-sm-4">
                 <div class="col-md-3 col-sm-4">
                    <img style="max-width: 50px;" src="'.$src.'" alt="">  
                 </div>
              ...
              <div class="col-md-3 col-sm-3 pull-right">
                ...
                echo "<a href='#'  class='btn btn-choose btn-sm' onclick=\"landingpage.showDetail('$data->ID_TRAVEL','$data->ID_KOTA_ASAL','$data->ID_KOTA_TUJUAN',$data->TARIF, $data->JML_KURSI, '$data->NAMA_TRAVEL', '$data->ID_JADWAL_TRAVEL', '$data->KOTAT_ASAL', '$data->KOTA_TUJUAN','";
              ...
              <div class="col-md-12 col-sm-12">
                <div id="demo'.$data->ID_JADWAL_TRAVEL.'" class="collapse">
                  <div class="col-md-4  col-sm-4">
                      <p>Gambar Mobil:</p>
                      <img src="'.$srcMobil.'" class="carImage img-responsive" alt="" style=" max-height: 160px; ">
                  </div>
                  <div class="col-md-4 col-sm-4">
                      <p>Nama Mobil:</p>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body modal-seat2">
                    ...
                    <div class="col-md-5 col-sm-5">
                        <img class="img img-responsive" id="imageDetail" src="" alt="">
                    </div>
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body modal-seat">
                    ...
                    <a href="<?php echo base_url();?>index.php/register/" class="btn btn-lg btn-info btn-block">Register</a>
                </div>
            </div>
        </div>
    </div>
