      ...
      <div class="container body">
         ...
         echo '<div class="col-md-12 col-sm-12 content">
            ...
            <div class="col-md-3 col-sm-3 pull-right">
               ...
               <?php 
                if ($this->session->userdata('logged_in') == TRUE) {
                  echo '<a href="" onClick="showDetail('.$data->ID_JADWAL_TRAVEL.')" data-toggle="modal" data-target="#choose'.$data->ID_JADWAL_TRAVEL.'"  class="btn btn-choose btn-sm">Choose</a>';
                } else {
                  echo '<a href="" data-toggle="modal" data-target="#choose"  class="btn btn-choose btn-sm">Choose</a>';
                }
            ...
            <div class="col-md-12 col-sm-12 see">
               <button type="button" class="see" data-toggle="collapse" data-target="#demo'.$data->ID_JENIS_KENDARAAN.'">See Detail>></button>
            </div>
            <div class="col-md-12 col-sm-12">
               <div id="demo'.$data->ID_JENIS_KENDARAAN.'" class="collapse">
                  <div class="col-md-4  col-sm-4">
                     <p>Gambar Mobil:</p>
                     <img src="'.base_url().'uploads/'.$data->FOTO_KENDARAAN.'" class="carImage img-responsive" alt="">
                  </div>
                  <div class="col-md-4 col-sm-4">
                     <p>Nama Mobil:</p>
